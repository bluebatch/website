...
export const metadata: Metadata = {
  ...
  description:
    "Wie bluebatch Steuerberater bei Dokumentenverarbeitung und Mandantenkommunikation unterstützt.",
  openGraph: {
    title: "Steuerberater – Use Cases",
    description:
      "Wie bluebatch Steuerberater bei Dokumentenverarbeitung und Mandantenkommunikation unterstützt.",
...
export default async function Page() {
  const subPages = await getSubPages("app/use-cases/steuerberater", (f) =>
    import(`./${f}/page`),
  );
  ...
  return (
    <ContentWrapper isFirstSection>
      ...
      <Typo.H1>Steuerberater</Typo.H1>
      <Typo.Paragraph>
        Automatisierung und digitale Workflows für Steuerkanzleien.
      </Typo.Paragraph>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
        {subPages.map((page) => (
          <Link
            key={page.slug}
            href={`/use-cases/steuerberater/${page.slug}`}
