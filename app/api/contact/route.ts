...
// Roh-UTM → HubSpot-Dropdowns. "Paid" = echter Ad-Klick (fbclid / hsa_src=fb /
// utm_medium=paid|cpc|ppc). Alles andere gilt als organisch/inbound.
function mapLead(utm: Record<string, string>, fbclid?: string | null): MappedLead {
