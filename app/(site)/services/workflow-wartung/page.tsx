...
export const rewriteSiteConfig: RewriteSiteConfig = {
  legacyRedirects: ["/workflow-wartung"],
  rewrites: [
      ],
};
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=Workflow%20Wartung%20%26%20Servicevertrag&eyebrow=Services",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Professionelle Wartung Ihrer n8n-Workflows mit 24/7 Monitoring und 99,9% Uptime-Garantie.",
    images: ["/og?title=Workflow%20Wartung%20%26%20Servicevertrag&eyebrow=Services"],
  },
  alternates: {
      ...
      <ContentWrapper bodyWidth="small">
        <div className="text-center">
          <Typo.Paragraph className="text-xl text-gray-700 leading-relaxed">
            ...
            <Link href="/services/n8n-hosting" className="text-primary-600 hover:underline">eigenem Hosting in Deutschland</Link>{" "}
            ...
            <SimpleGrid cols={2} className="items-center gap-12">
              <div>
                ...
                <Typo.Paragraph className="text-gray-700 mb-6">
                  ...
                  <Link href="/services/performance-scaling" className="text-primary-600 hover:underline">Performance-Scaling</Link>,
