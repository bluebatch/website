...
export const rewriteSiteConfig: RewriteSiteConfig = {
  legacyRedirects: ["/n8n-hosting-deutschland"],
  rewrites: [
      ],
};
      ...
      <ContentWrapper colorScheme="gray-light">
        <IntroBox>
          ...
          <IntroBox.Paragraph>
            ...
            <Link href="/blog/n8n-sicherheit-self-hosting" className="text-primary-600 hover:underline">n8n Sicherheit &amp; Self-Hosting</Link>;
