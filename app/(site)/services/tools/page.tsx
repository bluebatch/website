      ...
      <ContentWrapper>
        ...
        <div className="divide-y divide-gray-100">
          {automationTools.map((tool) => (
            <Link
              key={tool.slug}
              href={resolveHref(`/services/tools/${tool.slug}`)}
