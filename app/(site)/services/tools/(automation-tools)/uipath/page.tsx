...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=UiPath%3A%20Funktionen%2C%20Kosten%2C%20Grenzen%20%26%20Vergleich&eyebrow=Tools",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["/og?title=UiPath%3A%20Funktionen%2C%20Kosten%2C%20Grenzen%20%26%20Vergleich&eyebrow=Tools"],
  },
  alternates: {
    canonical: "/services/tools/uipath",
  },
};
...
export default function Page() {
  return (
    <>
      <SoftwareApplicationSchema slug="uipath" />
      {/* 1. Hero */}
      ...
      <ContentWrapper>
        ...
        <Typo.Paragraph className="text-gray-600 text-center max-w-3xl mx-auto">
          Sie suchen eine schlankere Alternative zu UiPath? Erfahren Sie{" "}
