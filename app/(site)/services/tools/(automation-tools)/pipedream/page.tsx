...
export default function Page() {
  return (
    <>
      <SoftwareApplicationSchema slug="pipedream" />
      {/* 1. Hero */}
      ...
      <ContentWrapper>
        ...
        <Typo.Paragraph className="text-gray-600 text-center max-w-3xl mx-auto">
          Sie vergleichen Developer-Plattformen? Erfahren Sie{" "}
          <Link href="/services/tools/n8n" className="text-primary-500 hover:underline">was n8n ist und wie es funktioniert</Link>, oder informieren Sie sich über{" "}
          <Link href="/services" className="text-primary-500 hover:underline">unsere Implementierungsservices</Link>.
        </Typo.Paragraph>
      </ContentWrapper>
