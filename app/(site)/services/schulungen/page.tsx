...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=n8n%20Schulung%20%26%20Workshops&eyebrow=Services",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["/og?title=n8n%20Schulung%20%26%20Workshops&eyebrow=Services"],
  },
  alternates: {
      ...
      <ContentWrapper colorScheme="gray-light" bodyWidth="small">
        <div className="text-center">
          ...
          <Typo.Paragraph className="text-gray-600 mb-8">
            ...
            <Link href="/services/custom-nodes" className="text-primary-600 hover:underline">Custom Nodes</Link>{" "}
            entwickelt werden und wie die langfristige{" "}
            <Link href="/services/workflow-wartung" className="text-primary-600 hover:underline">Wartung von Workflows</Link>{" "}
