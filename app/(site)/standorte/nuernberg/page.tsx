...
export const rewriteSiteConfig: RewriteSiteConfig = {
  legacyRedirects: ["/ki-agentur-nuernberg"],
  rewrites: [
      ],
};
      ...
      <ContentWrapper bodyWidth="small">
        ...
        <div className="mx-auto max-w-3xl space-y-6 mt-10">
          ...
          <Typo.Paragraph>
            ...
            <Link href="/branchen/steuerberater/workflows/datev-jira-task-orchestration" className="text-primary-600 hover:underline">DATEV-System</Link>.
