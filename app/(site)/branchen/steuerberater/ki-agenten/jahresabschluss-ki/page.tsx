...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=KI-Jahresabschluss&eyebrow=Steuerberater",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: defaultMeta.title,
    description: defaultMeta.ogDescription,
    images: ["/og?title=KI-Jahresabschluss&eyebrow=Steuerberater"],
  },
  alternates: {
    canonical: "/branchen/steuerberater/ki-agenten/jahresabschluss-ki",
  },
};
