...
const workflows = [
  {
    ...
    features: [
      ...
      { label: "Geprüfter Beleg statt 25 Min", badge: "<60 Sek" },
  ...
  },
  {
    ...
    features: [
      { label: "Multi-OCR Trefferquote", badge: "99%" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "SLA-Treffer nach Go-Live", badge: "+30%" },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Pro Rechnung statt 12 Minuten", badge: "30 Sek" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "DATEV-Anlage automatisch", badge: "2 Min" },
    ],
