...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=Mandanten-Onboarding&eyebrow=Steuerberater",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: defaultMeta.title,
    description: defaultMeta.ogDescription,
    images: ["/og?title=Mandanten-Onboarding&eyebrow=Steuerberater"],
  },
  alternates: {
    canonical: "/branchen/steuerberater/workflows/mandanten-onboarding",
  },
};
    ...
    <>
      ...
      <ContentWrapper colorScheme="gray-light" bodyWidth="small">
        <CrossSellGrid>
          ...
          <CrossSellGrid.Card href="/branchen/steuerberater/ki-agenten/mandantenkommunikation">
          ...
          <CrossSellGrid.Card href="/branchen/steuerberater/workflows/belegpruefung">
          ...
          <CrossSellGrid.Card href="/branchen/steuerberater">
