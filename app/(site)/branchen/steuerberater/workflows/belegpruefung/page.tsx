...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=Belegpr%C3%BCfung&eyebrow=Steuerberater",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: defaultMeta.title,
    description: defaultMeta.ogDescription,
    images: ["/og?title=Belegpr%C3%BCfung&eyebrow=Steuerberater"],
  },
  alternates: {
    canonical: "/branchen/steuerberater/workflows/belegpruefung",
  },
};
    ...
    <>
      ...
      <ContentWrapper colorScheme="gradient-cool">
        ...
        <div className="mt-10 text-center">
          <Link
            href="/branchen/grosshandel/roi-rechner/document?docs=300&before=11&after=1&hourly=65&tier=medium&setup=12000&maint=1500"
