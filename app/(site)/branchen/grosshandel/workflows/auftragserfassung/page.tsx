...
export const rewriteSiteConfig: RewriteSiteConfig = {
  legacyRedirects: ["/bestellung-erfassen"],
  rewrites: [
    {
    ...
    <>
      ...
      <ContentWrapper colorScheme="gray">
        ...
        <div className="mt-8 text-center">
          <Link
            href="/branchen/grosshandel/roi-rechner/document?docs=1700&before=24&after=10&hourly=28&tier=medium&setup=10000&maint=1000"
