  ...
  rewrites: [
    {
      ...
      keywords: [
        ...
        "AI Order Intake",
        "intelligente Bestellaufnahme",
        "Bestellaufnahme Großhandel",
        "Bluebatch",
      ],
    },
    {
      ...
      keywords: [
        ...
        "Bestelleingang automatisch",
        "Order Processing Software",
        "Großhandel Bestellprozess",
        "Bluebatch",
      ],
    },
    {
      ...
      keywords: [
        ...
        "Bestellungen automatisch verarbeiten",
        "Großhandel Prozessautomatisierung",
        "Bluebatch",
      ],
    },
    {
      ...
      keywords: [
        "KI Bestellabwicklung",
        "künstliche Intelligenz Bestellungen",
        "KI Order Management",
        "intelligente Bestellverarbeitung",
        "KI Großhandel Logistik",
        "Bluebatch",
      ],
    },
    {
      ...
      keywords: [
        ...
        "Bestellabwicklung Software",
        "automatische Auftragsabwicklung",
        "Großhandel Fulfillment",
        "Bluebatch",
      ],
    },
  ],
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "/og?title=Automatisierte%20Bestellabwicklung&eyebrow=Gro%C3%9Fhandel",
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title,
      description: overrides?.metaDescription ?? defaultMeta.ogDescription,
      images: ["/og?title=Automatisierte%20Bestellabwicklung&eyebrow=Gro%C3%9Fhandel"],
    },
    alternates: {
      canonical: "/branchen/grosshandel/workflows/bestellabwicklung",
    },
  };
}
