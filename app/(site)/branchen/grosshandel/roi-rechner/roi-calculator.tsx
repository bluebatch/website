...
const categoryMeta: Record<CategoryKey, { icon: React.ComponentType<{ className?: string }>; href: string }> = {
  document: { icon: FileCheck, href: "/branchen/grosshandel/roi-rechner/document" },
  "social-media-ads": { icon: Megaphone, href: "/branchen/grosshandel/roi-rechner/social-media-ads" },
  "service-requests": { icon: Headset, href: "/branchen/grosshandel/roi-rechner/service-requests" },
};
