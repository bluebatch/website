...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/branchen/personaldienstleister/bewerber-screening",
  },
};
    ...
    <>
      ...
      <ContentWrapper>
        ...
        <SavingsCard>
          ...
          <SavingsItems>
            <SavingsItem label="Setup einmalig">22.000 €</SavingsItem>
      ...
      <ContentWrapper>
        ...
        <Typo.Paragraph className="text-gray-600 text-center max-w-3xl mx-auto">
          Entdecken Sie{" "}
          <Link href="/branchen/personaldienstleister" className="text-primary-500 hover:underline">
            alle Personaldienstleister Use Cases
          </Link>
          , oder erfahren Sie mehr über{" "}
          <Link href="/branchen/personaldienstleister/bewerberkommunikation" className="text-primary-500 hover:underline">
