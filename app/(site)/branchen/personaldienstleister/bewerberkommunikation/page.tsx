...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/branchen/personaldienstleister/bewerberkommunikation",
  },
};
    ...
    <>
      ...
      <ContentWrapper>
        ...
        <Typo.Paragraph className="text-gray-600 text-center max-w-3xl mx-auto">
          ...
          <Link href="/branchen/personaldienstleister/bewerber-screening" className="text-primary-500 hover:underline">
