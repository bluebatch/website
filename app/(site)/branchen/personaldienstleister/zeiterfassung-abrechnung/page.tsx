...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/branchen/personaldienstleister/zeiterfassung-abrechnung",
  },
};
    ...
    <>
      ...
      <ContentWrapper>
        ...
        <Typo.Paragraph className="text-gray-600 text-center max-w-3xl mx-auto">
          ...
          <Link href="/branchen/personaldienstleister/compliance-ueberwachung" className="text-primary-500 hover:underline">
