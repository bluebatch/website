    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://calendly.com https://*.googletagmanager.com https://*.google-analytics.com https://js-eu1.hsforms.net https://static.hsappstatic.net https://*.hubspot.com https://*.posthog.com https://connect.facebook.net",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://calendly.com https://static.hsappstatic.net",
              ...
              "connect-src 'self' https://calendly.com https://*.google-analytics.com https://*.googletagmanager.com https://*.analytics.google.com https://analytics.google.com https://*.hsforms.com https://forms.hubspot.com https://*.hubspot.com https://static.hsappstatic.net https://*.posthog.com https://connect.facebook.net https://www.facebook.com https://*.facebook.com",
              "object-src 'none'",
              "base-uri 'self'",
