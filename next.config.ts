    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://calendly.com https://assets.calendly.com https://*.googletagmanager.com https://*.google-analytics.com https://js-eu1.hsforms.net https://static.hsappstatic.net https://*.hubspot.com",
              ...
              "connect-src 'self' https://calendly.com https://*.google-analytics.com https://*.googletagmanager.com https://*.analytics.google.com https://analytics.google.com https://*.hsforms.com https://forms.hubspot.com https://*.hubspot.com https://static.hsappstatic.net",
              "object-src 'none'",
              "base-uri 'self'",
